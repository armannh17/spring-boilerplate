...
public class MakeStoreReqDto {
  ...
  @Schema(
      description = "brief inro to your services",
      example = "biggest online shop...",
      required = true)
  @NotEmpty
  ...
  @Schema(
      description = "a short overview of your store",
      example = "top seller on industry...",
      required = true)
  @NotEmpty
  @Length(min = 1, max = 200)
  @TextValidator
  ...
  @Schema(
      description = "your uploaded cover image",
